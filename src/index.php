...
<html lang="en">
  ...
  <div class="container-fluid">
        <div class="row header">
            <div class="col-md-12">
                <img src="images/hm.jpg" style="width:100%; height: 500px" alt="" class="img-fluid">
            </div>
        </div>
        <!-- Start: Navigation --> 
                        ...
                        <?php 
                            ...
                            ?>        
                                    <tr>
                                        ...
                                        <td><a href="src/edit.php?bg_id=<?php echo $row['bg_id']; ?>"><i class="fas fa-edit"></i></a></td>
                                        <td><a href="src/delete.php?bg_id=<?php echo $row['bg_id']; ?>"><i class="fas fa-trash"></i></a></td> 
                                    </tr>
                        <?php
                                $i++;
                                }
